...
<body id="noticias-skate">
    ...
    <!-- ==================== HEADER ==================== -->
    <header class="navbar">
        <a href="../../../../public/index.php"><img src="../../../assets/img/img-noticias/Esportes/Skate.png" class="logo-urban" alt="Logo Urban"></a>
        ...
        <div class="container nav-container">
            ...
            <nav class="nav-links menu-desk">
                ...
                <a href="/src/pages/esportes.php" class="active">Esporte</a>
