...
<head>
    ...
    <title>Como conflitos globais e eleições influenciam o dólar frente ao real | The Urban Review</title>
    ...
    <main class="article-page">
        <div class="container">
            ...
            <h1 class="article-title">
                Como conflitos globais e eleições influenciam o dólar frente ao real
            </h1>

            <!-- Subtítulo -->
            <p class="article-subtitle">
                Guerras, disputas comerciais, juros nos Estados Unidos e o calendário eleitoral brasileiro tornam o câmbio cada vez mais sensível às expectativas dos investidores. Entenda por que eventos distantes afetam o bolso do brasileiro.
            </p>
            ...
            <figure class="article-image">
                <img src="../../../assets/img/img-noticias/internacional/noticia-geopolitica-destaque.jpg" alt="Geopolítica e câmbio - dólar e real">
                <figcaption>
                    Em um mundo cada vez mais conectado, o preço do dólar deixou de refletir apenas indicadores econômicos. Conflitos, eleições e decisões de bancos centrais influenciam diretamente a cotação frente ao real.
                </figcaption>
            </figure>
            ...
            <article class="article-content">
                ...
                <h2>Por que acontecimentos geopolíticos impactam o real?</h2>
                ...
                <h2>O peso das eleições e da política monetária</h2>

                <p>
                    Ao mesmo tempo, a política também pesa sobre o câmbio. Em períodos eleitorais, o mercado procura antecipar como diferentes programas econômicos poderão afetar a trajetória da dívida pública, da política fiscal e do crescimento econômico. Alterações nessas expectativas costumam ser rapidamente incorporadas aos preços dos ativos financeiros, incluindo a taxa de câmbio.
                </p>

                <p>
                    Em 2026, por exemplo, o calendário eleitoral brasileiro passou a dividir espaço com fatores externos nas análises do mercado, tornando o comportamento do real ainda mais sensível às expectativas dos investidores.
                </p>
                ...
                <h2>O Brasil não é apenas espectador</h2>
                ...
                <h2>Gestão cambial se torna estratégica</h2>
                ...
                <p class="article-author">
                    Gustavo Bevilacqua é economista.
                </p>
