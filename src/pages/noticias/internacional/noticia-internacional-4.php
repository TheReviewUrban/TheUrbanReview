...
<head>
    ...
    <title>Líderes mundiais se reúnem para discutir crises humanitárias e riscos de escalada | The Urban Review</title>
    ...
    <main class="article-page">
        <div class="container">
            ...
            <p class="article-subtitle">
                ONU pede cessar-fogo imediato, Europa cobra retomada das negociações e potências se dividem sobre ofensiva contra o Irã.
            </p>
            ...
            <figure class="article-image">
                <img src="../../../assets/img/img-noticias/internacional/diplomacia.png" alt="Contratação de Vozinha">
                <figcaption>
            ...
            <article class="article-content">
                <p class="article-lead">
                    A ofensiva dos Estados Unidos e de Israel contra o Irã, neste sábado (28), causou reações de líderes mundiais. Mais de 200 mortos e quase 750 feridos, segundo o Crescente Vermelho.
                </p>
