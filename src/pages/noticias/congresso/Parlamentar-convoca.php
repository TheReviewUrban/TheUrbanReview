...
<head>
    ...
    <title>Convocados não comparecem e CPMI do INSS adia depoimentos | The Urban Review</title>
    ...
    <main class="article-page">
        <div class="container">
            ...
            <p class="article-subtitle">
                Estavam previstos depoimentos de executivos da Crefisa, do banco C6 e da Dataprev. Presidente da comissão não descarta condução coercitiva.
            </p>
            <!-- Informações -->
            <div class="article-meta">
                ...
                <span>•</span>
                <span>9 de março de 2026</span>
            </div>
            <!-- Imagem principal -->
            <figure class="article-image">
                <img src="../../../../src/assets/img/img-noticias/congresso/noticia-cpi.jpg"
                    alt="Reunião da CPMI do INSS">
                <figcaption>
                    Reunião da CPMI do INSS desta segunda-feira (9) teve os três depoimentos previstos adiados. Foto: Kayo Magalhães/Câmara dos Deputados
                </figcaption>
            </figure>
            <!-- Conteúdo -->
            <article class="article-content">
                ...
                <h2>Leila Pereira e CEO do C6</h2>
                <p>
                ...
                <p>
                    <a href="https://www.camara.leg.br/noticias/1251682-convocados-nao-comparecem-e-cpmi-do-inss-adia-depoimentos/" target="_blank" rel="noopener">VEJA A NOTÍCIA ORIGINAL</a>
                </p>
            </article>
            <!-- Compartilhamento -->
