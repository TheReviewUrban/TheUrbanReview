...
<head>
    ...
    <title>Monte Everest: 20 curiosidades que você talvez não saiba sobre o ponto mais alto do mundo | The Urban Review</title>
...
<body id="noticias-inicio">
    ...
    <main class="article-page">
        <div class="container">
            ...
            <!-- Categoria -->
            <div class="article-category">CURIOSIDADE</div>
            ...
            <p class="article-subtitle">
                ...
                Everest não é apenas uma montanha, mas um símbolo de resistência
            </p>
            ...
            <figure class="article-image">
                <img src="../../../assets/img/img-noticias/inicio/curiosidade.jpg" alt="Contratação de Vozinha">
                <figcaption>
