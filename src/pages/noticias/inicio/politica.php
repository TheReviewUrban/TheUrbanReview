...
<body id="noticias-inicio">
    ...
    <!-- ==================== HEADER ==================== -->
    <header class="navbar">
        <a href="../../../../public/index.php"><img src="../../../../src/assets/img/ícones/LogoUrban.png" class="logo-urban"
                alt="Logo Urban"></a>
    ...
    <main class="article-page">
        <div class="container">
            ...
            <figure class="article-image">
                <img src="../../../assets/img/img-noticias/inicio/noticiadestaque.jpg" alt="Renan critica Flávio Bolsonaro">
                <figcaption>
