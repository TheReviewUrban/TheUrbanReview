...
<head>
    ...
    <title>The Urban Review - Economia</title>
...
<body id="economia">
    ...
    <header class="navbar">
        ...
        <div class="container nav-container">
            <div class="logo">
                ...
                <p>Análise econômica. Conteúdo que importa.</p>
            </div>
        ...
        <div class="carousel-container">
            <div class="carousel-track">
                ...
                <div class="carousel-slide active">
                    <img src="../../src/assets/img/img-noticias/economia/economia-noticia-destaque.jpg"
                        alt="Mercado financeiro" class="carousel-bg">
                    <div class="carousel-overlay">
                        <div class="container carousel-content">
                            <span class="badge badge-red">DESTAQUE</span>
                            <span class="meta-info">Mercado • há 2h</span>
                            <h2>Crise do BRB: 'Politizar é um erro', diz Celina após críticas de Durigan; empréstimo
                                segue travado</h2>
                ...
                <div class="carousel-slide">
                    <img src="../../src/assets/img/img-noticias/economia/economia-global.jpg" alt="Economia global"
                        class="carousel-bg">
                    <div class="carousel-overlay">
                        <div class="container carousel-content">
                            <span class="badge badge-blue">GLOBAL</span>
                            <span class="meta-info">Economia Internacional • há 3h</span>
                            <h2>Gasolina sobe 30% nos EUA e Trump cobra petroleiras; entenda o que está por trás da alta
                            </h2>
                ...
                <!-- SLIDE 3 -->
                <div class="carousel-slide">
                    <img src="../../src/assets/img/img-noticias/economia/economia-inflacao.jpg" alt="Inflação e preços"
                        class="carousel-bg">
                    <div class="carousel-overlay">
                        <div class="container carousel-content">
                            <span class="badge badge-purple">INFLAÇÃO</span>
                            <span class="meta-info">Preços • há 4h</span>
                            <h2>Expectativas de inflação de 1 ano nos EUA caem a 3,6% em julho e ficam estáveis a longo
                                prazo</h2>
                ...
                <!-- SLIDE 4 -->
                <div class="carousel-slide">
                    <img src="../../src/assets/img/img-noticias/economia/economia-juros.jpg" alt="Juros e política monetária"
                        class="carousel-bg">
                    <div class="carousel-overlay">
                        <div class="container carousel-content">
                            <span class="badge badge-yellow">JUROS</span>
                            <span class="meta-info">Política Monetária • há 5h</span>
    ...
    <main class="container main-content">
        ...
        <section class="news-grid">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-emprego.png');"></div>
                <div class="card-body">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-cambio.png');"></div>
                <div class="card-body">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-inflacao2.png');">
                </div>
                <div class="card-body">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-empresas.png');"></div>
                <div class="card-body">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-creditos.png');"></div>
                <div class="card-body">
            ...
            <article class="news-card">
                <div class="card-img"
                    style="background-image: url('../../src/assets/img/img-noticias/economia/economia-bancos.png');"></div>
                <div class="card-body">
        ...
        <section class="news-grid">
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Divulgação de indicadores de atividade econômica e mercado financeiro.</h4>
                </div>
            </article>
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Divulgação de dados de inflação e acompanhamento dos preços ao consumidor.</h4>
                </div>
            </article>
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Mercado acompanha decisões e declarações relacionadas à política monetária.</h4>
                </div>
            </article>
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Divulgação de indicadores do mercado de trabalho e atividade das empresas.</h4>
                </div>
            </article>
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Dados sobre comércio, indústria e desempenho da economia nacional.</h4>
                </div>
            </article>
            ...
            <article class="news-card">
                <div class="card-body">
                    ...
                    <h4>Análise dos principais acontecimentos econômicos da semana.</h4>
                </div>
            </article>
    ...
    <footer class="footer">
        <div class="container footer-grid">
            ...
            <!-- Logo -->
            <img src="../../src/assets/img/ícones/LogoEconomia.png" class="logo-urban" alt="Logo Economia Footer">
